...
wrap at the pane edge by default (toggle **Wrap**). The folder list can be hidden; drag the
splitters between folders, the version list, and the diff so long-form text gets the width
it needs. A **command
